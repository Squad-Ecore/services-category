...
public class ErroDeValidacaoHandler {
    //handler é um interceptador que é chamado sempre que tiver exception dentro do controller
    @Autowired
    private MessageSource messageSource;

    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    @ExceptionHandler(MethodArgumentNotValidException.class) //especificação da exception dentro do controller
